...
<div class="row pt-5">
            ...
            <div class="col-md bg-light my-3">
                ...
                <form class="w-75 py-4 m-auto" action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="alamat" class="form-control" id="alamat" required name="alamat">
                    </div>
                    <div class="form-group">
    ...
    <select class="form-control" id="kelamin" name="kelamin" required>
        ...
        <option value="Lainnya">Lainnya</option>
                    ...
                    <div class="form-group">
                        <label for="infotali">info talikur darimana</label>
                        <input type="text" class="form-control" id="infotali" required name="infotali">
                    </div>
                    <div class="form-group ">
